...
type CacheManager interface {
	...
	GetOrCreate(ctx context.Context, key string, dest any, factory func() (any, error), opts ...Option) error
	...
	SetMany(ctx context.Context, items map[string]any, opts ...Option) error
